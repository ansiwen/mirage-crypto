...
{
	CAMLparam3(out, a, b);
	fiat_secp521r1_sub((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam3(out, a, b);
	fiat_secp521r1_add((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam3(out, a, b);
	fiat_secp521r1_mul((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_square((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_from_montgomery((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_to_montgomery((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam1(x);
    fiat_secp521r1_set_one((limb_t*)Bytes_val(x));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_scalar_inv((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam3(out, a, b);
	fiat_secp521r1_scalar_mul((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam3(out, a, b);
	fiat_secp521r1_scalar_add((limb_t*)Bytes_val(out), (const limb_t*)String_val(a), (const limb_t*)String_val(b));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam1(out);
	fiat_secp521r1_scalar_set_one((limb_t*)Bytes_val(out));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_scalar_from_bytes((limb_t*)Bytes_val(out), _st_uint8(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_scalar_to_bytes(Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_scalar_from_montgomery((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
...
{
	CAMLparam2(out, in);
	fiat_secp521r1_scalar_to_montgomery((limb_t*)Bytes_val(out), (const limb_t*)String_val(in));
	CAMLreturn(Val_unit);
}
